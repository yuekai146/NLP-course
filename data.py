...
def example_generator(data_path, single_pass):
  ...
  Args:
    data_path:
      Path to tf.Example data files. Can include wildcards, e.g. if you have several training data chunk files train_001.bin, train_002.bin, etc, 
  ...
  while True:
    ...
    for f in filelist:
      ...
      while True:
        ...
        str_len = struct.unpack('q', len_bytes)[0] #'q' is means format string is long long.
